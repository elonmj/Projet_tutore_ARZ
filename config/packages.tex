...
\usepackage[T1]{fontenc}            % Font encoding (for better hyphenation and accented characters)
\usepackage{lmodern}              % Latin Modern font (good default, scalable version of CM)
...
\graphicspath{{../assets/figures/}} % Relative path from main.tex to figures folder
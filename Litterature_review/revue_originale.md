...
*   **Comportements non physiques potentiels :** Des choix inappropriés de \( p(\rho) \) peuvent conduire à des densités maximales multiples ou à des vitesses négatives dans certaines conditions [[Developing an Aw–Rascle model of traffic flow - ResearchGate](https://www.researchgate.net/publication/282547196_Developing_an_Aw-Rascle_model_of_traffic_flow); @FanWork2015]. Des versions modifiées (e.g., GARZ) visent à corriger cela [@FanHertySeibold2014].
